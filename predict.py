...
model = create_model(NCLASSES,HEIGHT,WIDTH)
model.load_weights(r"E:\海漂垃圾自动识别\efficientnet\worklogs\撑架efficientdeeplabv3+middle2.h5")
#model.load_weights(r"E:\海漂垃圾自动识别\efficientnet\chengjialog\deeplabv3+_middle1.h5")
#model.load_weights(r"E:\海漂垃圾自动识别\efficientnet\logs\middle1.h5")
...
for jpg in imgs:
    ...
    seg_img.save("E:\\海漂垃圾自动识别\\样本集\\平潭苏澳镇龙头至苏澳岸段\\test\\"+jpg,'TIFF')
