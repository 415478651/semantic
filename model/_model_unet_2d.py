...
def unet_2d(input_size, n_labels, filter_num=[64, 128, 256, 512], stack_num_down=2, stack_num_up=2,
            activation='ReLU', output_activation='Softmax', batch_norm=False, pool=True, unpool=True, 
            backbone=None, weights='imagenet', freeze_backbone=False, freeze_batch_norm=False, name='unet'):
    '''
