...
from model.transformer_layers import patch_extract, patch_embedding
...
def transunet_2d_base(input_tensor, filter_num, stack_num_down=2, stack_num_up=2, 
                      embed_dim=768, num_mlp=128, num_heads=6, num_transformer=3,
...
def transunet_2d(input_size,  n_labels,filter_num=[64, 128, 256, 512], stack_num_down=2, stack_num_up=2,
                 embed_dim=768, num_mlp =128, num_heads=6, num_transformer=3,
