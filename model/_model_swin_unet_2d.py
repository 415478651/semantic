...
from model.transformer_layers import patch_extract, patch_embedding, SwinTransformerBlock, patch_merging, patch_expanding
...
def swin_unet_2d(input_size, n_labels,filter_num_begin=48, depth=4, stack_num_down=2, stack_num_up=2, 
                      patch_size=(2,2), num_heads=[4, 8, 16, 16], window_size=[4, 2, 2, 2], num_mlp=128, output_activation='Softmax', shift_window=True, name='swin_unet'):
    '''
    The base of SwinUNET.
    X = swin_transformer_stack(X, stack_num=stack_num_down, 
                               embed_dim=embed_dim, num_patch=(num_patch_x, num_patch_y), 
